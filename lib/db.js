...
// sinon, souvent des variantes d'orthographe isolées) mais `overall` reste le vrai total global
// (issu de getStats(), non filtré) pour que la ligne "Total" ne sous-compte pas.
async function resolutionStats() {
