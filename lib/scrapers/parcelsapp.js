...
module.exports = async function handler(req, res) {
  ...
  // Valeur volontairement agressive (au prix d'un risque de plantage plus élevé si la fonction
  // sature en mémoire/CPU — accepté explicitement pour privilégier la vitesse) : plus de pages en
  // parallèle dans la même fonction accélère le débit par lot sans multiplier les fonctions Vercel
  // simultanées côté client (voir MAX_CONCURRENT_SCRAPES, assets/script.js).
