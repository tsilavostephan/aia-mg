...
module.exports = async function handler(req, res) {
  ...
  // 3 pages en parallèle provoquait des plantages complets de la fonction (page d'erreur Vercel
  // brute au lieu d'une réponse JSON) — probablement une saturation mémoire/CPU de la fonction
  // serverless avec 3 instances de Chromium "stealth" simultanées. 2 reste plus rapide que le
  // traitement séquentiel d'origine, avec moins de risque de dépasser les ressources allouées.
