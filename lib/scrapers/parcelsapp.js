...
module.exports = async function handler(req, res) {
  ...
  // Réduit à 2 (au lieu de 4) : plusieurs transporteurs "furtifs" peuvent tourner en même temps
  // côté client, chacun lançant potentiellement plusieurs invocations Vercel simultanées — un pool
  // trop large par fonction multiplie le risque de saturer Chromium (mémoire/CPU) une fois cumulé,
  // au prix d'un débit par lot un peu moindre.
